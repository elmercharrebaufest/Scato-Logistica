    ...
    public class ExcepcionAlControlProveedorMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            Mapper.CreateMap<ExcepcionAlControlProveedor, ExcepcionAlControlProveedorDto>()
                  ...
                  .ForMember(t => t.ProveedorDestinoId, f => f.MapFrom(r => r.ProveedorDestino.Id))
                  .ForMember(t => t.DestinoNombre, f => f.MapFrom(r => r.CentroDestino != null ? r.CentroDestino.Descripcion : r.ClienteDestino != null ? r.ClienteDestino.Descripcion : r.ProveedorDestino != null ? r.ProveedorDestino.Descripcion : ""));
