    ...
    public class CallePorRecorridoMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            Mapper.CreateMap<CallePorRecorrido, CallePorRecorridoDto>()
                  ...
                  .ForMember(t => t.CalleRecorridoId, f => f.MapFrom(r => r.Recorrido != null && r.Recorrido.Calle != null ? r.Recorrido.Calle.Id : (int?)null))
                  .ForMember(t => t.RecorridoId, f => f.MapFrom(r => r.Recorrido != null ? r.Recorrido.Id : (int?)null));
