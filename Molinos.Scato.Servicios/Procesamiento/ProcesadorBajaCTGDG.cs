...
{
    public class ProcesadorBajaCTGDG : ProcesadorComando<DarDeBajaCTGDG>
    {
        private readonly CTGServicePortType serviceAfipCtg;
        private readonly IAccesoWsCtg accesoWsCtg;
        public ProcesadorBajaCTGDG(IRepositorio repositorio, IConversor conversor, ILogger log,
        ...
        public override Resultado Ejecutar(DarDeBajaCTGDG comando)
        {
            /////////////
            ...
            if (bajaCtg == null)
            {
                Repositorio.Agregar(
                  new BajaCTG
                  {
                      ...
                      CodigoDeBaja = (!resultado.HayErrores) ? "ProcesadorBajaCTG" : null,
                      Fecha = DateTime.Now,
            ...
            {
                bajaCtg.CodigoDeBaja = (!resultado.HayErrores) ? "ProcesadorBajaCTG" : null;
