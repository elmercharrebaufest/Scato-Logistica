...
{
    public class ProcesadorCrearCartaPorteByPass : ProcesadorComando<CrearCartaPorteByPass>
    {
        public ProcesadorCrearCartaPorteByPass(IRepositorio repositorio, IConversor conversor, ILogger log)
            : base(repositorio, conversor, log)
        {
        }

        public override Resultado Ejecutar(CrearCartaPorteByPass comando)
        {
            ...
            try
            {
                ...
                if (workflow != null)
                {
                    ...
                    var almacen = Repositorio.Obtener<Almacen>(comando.Orden.CartaPorteByPass.AlmacenId ?? 0);
                    var calado = Repositorio.Obtener<Calado>(comando.Orden.CartaPorteByPass.Calado.Id);
                    ...
                    if (recorrido == null)
                    {
                        recorrido = new Recorrido
                        {
                            ...
                            Usuario = comando.Orden.CartaPorteByPass.NombreUsuario,
                            ...
                            Material = material,
                            PesoBruto = comando.Vehiculo.PesoBrutoOrigen,
                            PesoTara = comando.Vehiculo.PesoTaraOrigen,
                            ...
                            Almacen = almacen,
                            Establecimiento = comando.Orden.CartaPorteByPass.EstablecimientoId.HasValue ? Repositorio.Obtener<Establecimiento>(comando.Orden.CartaPorteByPass.EstablecimientoId.Value) : null,
                            PesoBrutoFecha = DateTime.Now,
                            PesoTaraFecha = DateTime.Now,
                            PesoBrutoUsuario = comando.Orden.CartaPorteByPass.NombreUsuario,
                            PesoTaraUsuario = comando.Orden.CartaPorteByPass.NombreUsuario,
                            Calado = calado
                    ...
                    {
                        var vehiculo = cartaPorte.Vehiculos.FirstOrDefault(t => t.Patente == comando.Vehiculo.Patente);
                        vehiculo.PesoBrutoOrigen = recorrido.PesoBruto ?? 0;
                        vehiculo.PesoTaraOrigen = recorrido.PesoTara ?? 0;
                        vehiculo.PesoNetoOrigen = recorrido.PesoBruto?? 0 - recorrido.PesoTara ?? 0;
                        recorrido.Usuario = comando.Orden.CartaPorteByPass.NombreUsuario;
                        ...
                        recorrido.PesoBruto = comando.Vehiculo.PesoBrutoOrigen;
                        recorrido.PesoTara = comando.Vehiculo.PesoTaraOrigen;
                        ...
                        recorrido.Establecimiento = comando.Orden.CartaPorteByPass.EstablecimientoId.HasValue ? Repositorio.Obtener<Establecimiento>(comando.Orden.CartaPorteByPass.EstablecimientoId.Value) : null;
                        recorrido.PesoBrutoFecha = DateTime.Now;
                        recorrido.PesoTaraFecha = DateTime.Now;
                        recorrido.PesoBrutoUsuario = comando.Orden.CartaPorteByPass.NombreUsuario;
                        recorrido.PesoTaraUsuario = comando.Orden.CartaPorteByPass.NombreUsuario;
                        recorrido.Calado = calado;
                    }
