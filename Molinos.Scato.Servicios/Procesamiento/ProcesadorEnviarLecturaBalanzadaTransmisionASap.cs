    ...
    public class ProcesadorEnviarLecturaBalanzadaTransmisionASap : ProcesadorComando<EnviarLecturaBalanzadaTransmisionASap>
    {
        ...
        public override Resultado Ejecutar(EnviarLecturaBalanzadaTransmisionASap comando)
        {
            ...
            using (var transaction = new TransactionScope(TransactionScopeOption.Suppress))
            {
                ...
                var configMov311 = 
                    this.Repositorio.ObtenerPrimero<ConfiguracionGeneral>(
                        x => x.Pantalla == Constantes.ConfiguracionGeneral.Pantalla.ServicioSap
                          && x.Nombre == Constantes.ConfiguracionGeneral.ServicioSap.HabilitarEnvioMov311);

                // Si la configuracion general no existe o esta habilitada, se envia el MOV_311
                bool habilitarEnvioMov311 = 
                    configMov311 == null || (bool.TryParse(configMov311.Valor, out bool valorMov311) && valorMov311);
                ...
                {
                    Log.Info("Envio SAP MOV_311 deshabilitado por ConfiguracionGeneral (" +
                        Constantes.ConfiguracionGeneral.Pantalla.ServicioSap + ", " + Constantes.ConfiguracionGeneral.ServicioSap.HabilitarEnvioMov311 + 
                        "). Balanzada: " + balanzada.Id + ", Balanza: " + balanzada.NumeroBalanza);
                }
