...
{
    public class CrearAsignacionAutomatismoGranoEnRecorrido : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var recorridoEnAutomatismo = new Dominio.Comandos.CrearAsignacionAutomatismoGranoEnRecorrido
            {
