...
{
    public class CrearOrdenCargaInternaFason : CodeActivity<Resultado>
    {
        [RequiredArgument]
        public InArgument<OrdenCargaInternaFasonDto> Orden { get; set; }
       ...
       [RequiredArgument]
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                var resultadoCrear = servicioComandos.Ejecutar(new Dominio.Comandos.CrearOrdenCargaInternaFason
                {
                    Orden = orden,
                ...
                var ordenDto = srvRepositorio.ObtenerOrdenCargaInternaFason(resultado.Id);
                if (ordenDto != null)
                {
