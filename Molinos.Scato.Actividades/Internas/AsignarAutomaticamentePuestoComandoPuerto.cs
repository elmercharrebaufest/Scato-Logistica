...
{
    public class AsignarAutomaticamentePuestoComandoPuerto : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            if (asignacionDeRecorrido != null)
            {
                ...
                var resultado =
                    servicioComandos.Ejecutar(new ActualizarPuestoComandoPuerto
                        {
                            Dto = asignacionDto
                        }) as ResultadoPuestoComandoPuerto;
