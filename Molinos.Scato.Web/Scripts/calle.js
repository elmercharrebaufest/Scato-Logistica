...
function mostrarBloque() {
    if ($('#TipoCalle').val() == "PreCalado" || $('#TipoCalle').val() == "Circular" || $('#TipoCalle').val() == "NoGranos" || $('#TipoCalle').val() == "PlantaNoGranos") { // pre calado
        $('.material-group').css('display', '');
        $('.calidad-group').css('display', 'none');
        $('.caracteristicas-calidad-group').css('display', 'none');
        if($('#TipoCalle').val() == "NoGranos" || $('#TipoCalle').val() == "PlantaNoGranos") {
