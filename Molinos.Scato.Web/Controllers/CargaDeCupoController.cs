    ...
    public class CargaDeCupoController : BaseController
    {
        ...
        public JsonResult Index(CargaDeCupoDto model, bool AvanceCpe, DatosUsuario datosUsuario)
        {
            ...
            else
            {
                ...
                servicioComandos.Ejecutar(new RegistrarMarcaDeTiempo { Tipo = TipoRegistroMarcaDeTiempo.Fin, PuestoDeTrabajoId = datosUsuario.PuestoDeTrabajoId });
            }
        ...
        public JsonResult ObtenerCPEPorPatente(DatosUsuario datosUsuario, string patente, string tarjeta = "", bool esEspecial = false, int? materialId = null)
        {
            try
            {
                ...
                servicioComandos.Ejecutar(new RegistrarMarcaDeTiempo { Tipo = TipoRegistroMarcaDeTiempo.Inicio, PuestoDeTrabajoId = datosUsuario .PuestoDeTrabajoId});
