CREATE TABLE [dbo].[MuestraDeNirs] (
    ...
    CONSTRAINT [PK_dbo.MuestraDeNirs] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_MuestraDeNirs_WorkflowInstanceId]
    ON [dbo].[MuestraDeNirs]([WorkflowInstanceId] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
