CREATE TABLE [dbo].[Balanzada] (
    ...
    CONSTRAINT [PK_dbo.Balanzada] PRIMARY KEY CLUSTERED ([Id] ASC, [NumeroBalanza] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Balanzada_CargaInicial_IdCargaInicial_NumeroBalanza]
    ON [dbo].[Balanzada]([CargaInicial_Id] ASC, [CargaInicial_NumeroBalanza] ASC)
    INCLUDE([PesoNeto]) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
