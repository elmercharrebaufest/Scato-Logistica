...
CREATE NONCLUSTERED INDEX [IX_PuestoDeTrabajo_Id]
    ON [dbo].[ControlRecorrido]([PuestoDeTrabajo_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
GO
CREATE NONCLUSTERED INDEX [IX_ControlRecorrido_WorkflowInstanceId]
    ON [dbo].[ControlRecorrido]([WorkflowInstanceId] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_ActividadXaml_PuestoDeTrabajo_id]
    ...
    INCLUDE([WorkflowInstanceId]) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
