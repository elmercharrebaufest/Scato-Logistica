CREATE TABLE [dbo].[OrdenCargaInterna] (
    ...
    CONSTRAINT [FK_dbo.OrdenCargaInterna_dbo.Cliente_PagadorFlete_Id] FOREIGN KEY ([PagadorFlete_Id]) REFERENCES [dbo].[Cliente] ([Id])
);
...
CREATE NONCLUSTERED INDEX [IX_Transportista_Id]
    ON [dbo].[OrdenCargaInterna]([Transportista_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_TipoComercial_Id]
    ON [dbo].[OrdenCargaInterna]([TipoComercial_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Material_Id]
    ON [dbo].[OrdenCargaInterna]([Material_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Destino_Id]
    ON [dbo].[OrdenCargaInterna]([Destino_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Chofer_Id]
    ON [dbo].[OrdenCargaInterna]([Chofer_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Recorrido_Id]
    ON [dbo].[OrdenCargaInterna]([Recorrido_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
