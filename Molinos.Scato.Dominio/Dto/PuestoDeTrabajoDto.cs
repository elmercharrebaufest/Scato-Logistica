...
namespace Molinos.Scato.Dominio.Dto
{
    public sealed class PuestoDeTrabajoDto
    {
        ...
        //si es false, la foto se toma al cargar la patente
        ...
        public string VideoCamarasString { get { return VideoCamaras != null ? String.Join(", ", VideoCamaras.Select(y => y.Codigo)) : ""; } }
        ...
        public string NombreGarita { get
            {
