...
{
    public class OrdenCargaFasValidator : AbstractValidator<OrdenCargaFasDto>, IValidatorEntity<OrdenCargaFasDto>

    {
        public OrdenCargaFasValidator()
        {
        ...
        {
            var properties = typeof(OrdenCargaFasDto).GetProperties();
