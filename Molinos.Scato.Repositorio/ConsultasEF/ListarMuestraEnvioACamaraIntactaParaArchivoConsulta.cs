...
{
    public class ListarMuestraEnvioACamaraIntactaParaArchivoConsulta : IConsulta<MuestraEnvioACamaraBiotecnoligiaDto>
    {
        private readonly int loteId;
        private readonly string codigoSapFirma;

        public ListarMuestraEnvioACamaraIntactaParaArchivoConsulta(int loteId, string codigoSapFirma)
        {
            this.loteId = loteId;
        ...
        public List<MuestraEnvioACamaraBiotecnoligiaDto> Ejecutar(DbContext contexto)
        {
            ...
            return (from muestra in contexto.Set<MuestraEnvioACamaraBiotecnologia>()
