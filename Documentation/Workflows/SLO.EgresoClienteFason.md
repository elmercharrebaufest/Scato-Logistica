# Workflow: SLO_EgresoClienteFason

> **Archivo:** `SLO.EgresoClienteFason.xamlx`  
> **Tipo de raiz:** Flowchart  
> **Generado:** 2026-08-06 18:43  
> **Actividades custom:** 32  
...
flowchart TD
    ...
    A23[ServicioSapIngresosEgresosFazones]
    A24[VerificacionCot]
    A25[SalidaDeCentro]
    A26[AutorizarTransportistaInhabilitado]
    A27[VerificacionTransportistaHabilitado]
    A28[VerificacionSalidaFlete]
    A29[IngresoDeTransportistaOrdenCargaInternaFason]
    A30[VerificacionTransportistaExiste]
    A31[IngresarOrdenCargaInternaFason]
    D32{"transportistaAutorizado"}
    D33{"vehiculoEnCondiciones"}
    D34{"autorizarTiempo"}
    D35{"camionRechazado"}
    D36{"excedePesoMaximo"}
    D37{"debeRepesar"}
    D38{"transportistaHabilitado"}
    D39{"existeTransportista"}
    D40{"salidaVerificada"}
    A25 --> A22
    A22 --> A2
    A2 --> A3
    A3 --> A4
...
| 24 | `ServicioSapIngresosEgresosFazones` | nombreUsuario, TipoMovimiento, instanceId, FechaIngreso, MaterialId |
...
| 29 | `VerificacionSalidaFlete` | hndInstance, choferId, centroId, transportistaId, patente |
| 30 | `IngresoDeTransportistaOrdenCargaInternaFason` | workflowId, ordenCargaInternaFason, hndInstance, puestoDeTrabajoId, nombreUsuario |
| 31 | `VerificacionTransportistaExiste` | WorkflowId, Result, PuestoDeTrabajoId, TransportistaId |
| 32 | `IngresarOrdenCargaInternaFason` | hndInstance, tipoDocumentoIngreso, centroId, orden, numeroDocumentoIngreso |
