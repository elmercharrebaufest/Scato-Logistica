...
function Calle(item, context) {
    ...
    self.Color = item.MaterialId == 63734 ? "bg-AceiteSj" : item.MaterialId == 4 ? "bg-soja" : item.MaterialId == 386 ? "bg-maiz" : item.MaterialId == 13 ? "bg-naranja" : item.MaterialId == 5 ? "bg-warning" : item.MaterialId == 81223 ? "bg-harina" : item.MaterialId == 63750 ? "bg-pellet" : item.MaterialId == 63736 ? "bg-Biodiesel" : item.MaterialId == 63691 ? "bg-AceiteG" : item.MaterialId == 172798 ? "bg-AceiteG" : item.MaterialId > 0 ? "bg-dark" : (self.TipoCalle == 1 ? 'bg-vacio' : "");
...
function AceptarCambioModalidad(calle) {
    $.blockUI({
        blockMsgClass: 'blocuiBox',
        message: '<h5>' + cargandoGif() + (calle.Automatica() ? 'Desactivando' : 'Activando') + ' llamando automático para ' + calle.Nombre + '</h5>'
    });
...
function Camion(item, calle) {
    ...
    self.Color = item.MaterialId == 63734 ? "bg-AceiteSj" : item.MaterialId == 4 ? "bg-soja" : item.MaterialId == 386 ? "bg-maiz" : item.MaterialId == 13 ? "bg-naranja" : item.MaterialId == 5 ? "bg-warning" : item.MaterialId == 81223 ? "bg-harina" : item.MaterialId == 63750 ? "bg-pellet" : item.MaterialId == 63736 ? "bg-Biodiesel" : item.MaterialId == 63691 ? "bg-AceiteG" : item.MaterialId == 172798 ? "bg-AceiteG" : item.MaterialId > 0 ? "bg-dark" : 'bg-vacio';
...
function EstadoDeCallesViewModel() {
    ...
    self.CantidadPelletGirasol = ko.computed(function () { return self.sumarCamiones(172798); });
    ...
    self.Biodiesel = ko.computed(function () { return self.sumarCamiones(63736); });
