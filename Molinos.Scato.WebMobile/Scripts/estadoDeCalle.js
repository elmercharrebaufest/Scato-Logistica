...
function Calle(item, context) {
    ...
    self.Color = item.MaterialId == 63734 ? "bg-AceiteSj" : item.MaterialId == 4 ? "bg-soja" : item.MaterialId == 386 ? "bg-maiz" : item.MaterialId == 13 ? "bg-naranja" : item.MaterialId == 5 ? "bg-warning" : item.MaterialId == 81223 ? "bg-harina" : item.MaterialId == 63750 ? "bg-pellet" : item.MaterialId == 81252 ? "bg-Biodiesel" : item.MaterialId == 63691 ? "bg-AceiteG" : item.MaterialId == 172798 ? "bg-PelletG" : item.MaterialId == 81322 ? "bg-AceiteNeutralizado" : item.MaterialId > 0 ? "bg-dark" : (self.TipoCalle == 1 ? 'bg-vacio' : "");
...
function Camion(item, calle) {
    ...
    self.Color = item.MaterialId == 63734 ? "bg-AceiteSj" : item.MaterialId == 4 ? "bg-soja" : item.MaterialId == 386 ? "bg-maiz" : item.MaterialId == 13 ? "bg-naranja" : item.MaterialId == 5 ? "bg-warning" : item.MaterialId == 81223 ? "bg-harina" : item.MaterialId == 63750 ? "bg-pellet" : item.MaterialId == 81252 ? "bg-Biodiesel" : item.MaterialId == 63691 ? "bg-AceiteG" : item.MaterialId == 172798 ? "bg-AceiteG" : item.MaterialId == 81322 ? "bg-AceiteNeutralizado" : item.MaterialId > 0 ? "bg-dark" : 'bg-vacio';
...
function EstadoDeCallesViewModel() {
    ...
    self.CantidadBiodiesel = ko.computed(function () { return self.sumarCamiones(81252); });
    self.CantidadAceiteNeutralizado = ko.computed(function () { return self.sumarCamiones(81322); });
